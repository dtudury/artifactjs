...
function dependencyMap(targets, components) {
    this.targets = targets = _.isArray(targets) ? _.clone(targets) : targets === undefined ? [] : [targets];
    this.components = components = _.isArray(components) ? _.clone(components) : components === undefined ? [] : [components];
